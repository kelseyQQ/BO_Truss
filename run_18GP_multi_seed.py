...
GEN_FILE = THIS_DIR / "18GP_generate_initial_data_snap.py"
BO_FILE = THIS_DIR / "18GP_bayesian_optimization_main_discrete_snap_revise.py"
...
def run_one_seed(seed: int, n_init: int = 4000, n_iter: int = 100, results_root: Optional[Path] = None):
    ...
    plot_src = THIS_DIR / "best_weight_vs_iteration.png"
...
if __name__ == "__main__":
    run_all_seeds(seeds=[3, 7, 11, 23, 35, 42, 56, 78, 99, 123], n_init=4000, n_iter=100)

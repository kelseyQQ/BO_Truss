...
def generate_initial_data(n_init=4000, save_path="initial_data_discrete.npz"):
    ...
    #Geometrical bias for x and y!
    X_samples_y_unscaled = generate_lhs_samples_height(n_init, bounds=[[-225, 245], [-225, 245], [-225, 245], [-225, 245]])
...
if __name__ == "__main__":
    ...
    generate_initial_data(n_init=4000, save_path="initial_data.npz")
    end_time = time.time()

...
from elasticmaterial import E_PROP, NU_PROP, RHO_PROP, ANMODEL_PROP, PLANE_STRESS, BAR
...
class J2Material(ElasticMaterial):
    ...
    class _Yield1D (_Yield):
        ...
        def yield_function(self,dgam): 
            ...
            der = -self._E * n - self._dsigy(self._new_kappa)
        ...
        def tangent_stiffness(self):
            ...
            der_depsp = self._E * n * self._E / (self._E + h)
